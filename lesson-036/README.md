# Lesson 036 - Data Preprocessing
        ...
        Overview
        - Prepare features with scaling, encoding, normalization, and feature engineering.
        ...
        Learning outcomes
        - Explain the main idea of data preprocessing in simple language.
...
- compare baseline, improvement, and failure cases
        ...
        Practice samples
        1. a preprocessing pipeline for numeric and categorical data
