# Lesson 017 - Modules and Packages
        ...
        Overview
        - Organize code across files and use import, pip, and venv with confidence.
        ...
        Learning outcomes
        - Explain the main idea of modules and packages in simple language.
...
- explain the trade-off between the quick solution and the reusable solution
        ...
        Practice samples
        1. a small package layout with local imports
