# Lesson 035 - Introduction to Machine Learning
        ...
        Overview
        - Explain supervised, unsupervised, and reinforcement learning and the ML workflow.
        - Prepare data, train baseline models, and evaluate predictions with discipline.
        - The session focuses on one clear topic, three guided practice tasks, and a short homework extension.

        Learning outcomes
        - Explain the main idea of introduction to machine learning in simple language.
...
- compare baseline, improvement, and failure cases
        ...
        Practice samples
        1. a machine learning map that separates task types
        ...
        Homework
        - Repeat the modeling workflow with a different split, feature set, or algorithm.
        - Save one mistake, one fix, and one takeaway in your own study notes.

        Self-practice
        - Spend 1 hour on the workflow and 1 hour on evaluation, error analysis, or improvement.
