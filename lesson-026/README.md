# Lesson 026 - Exploratory Data Analysis
        ...
        Overview
        - Use summary statistics and visualization to understand a dataset quickly.
        - Use arrays, tables, cleaning steps, and charts to understand real datasets.
        - The session focuses on one clear topic, three guided practice tasks, and a short homework extension.

        Learning outcomes
        - Explain the main idea of exploratory data analysis in simple language.
...
- look for shape, type, or distribution issues before moving on
        ...
        Practice samples
        1. an EDA notebook that explains patterns and relationships
        ...
        Homework
        - Repeat the data workflow on a second dataset and write down what changed.
        - Save one mistake, one fix, and one takeaway in your own study notes.

        Self-practice
        - Spend 30 minutes repeating the workflow and 60 minutes comparing two different datasets or charts.
