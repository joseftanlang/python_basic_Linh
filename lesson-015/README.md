# Lesson 015 - Object-Oriented Programming Part 1
        ...
        Overview
        - Define classes, objects, and attributes to model real-world entities.
        ...
        Learning outcomes
        - Explain the main idea of object-oriented programming part 1 in simple language.
...
- explain the trade-off between the quick solution and the reusable solution
        ...
        Practice samples
        1. a class-based student model with readable output
