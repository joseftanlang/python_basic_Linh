# Lesson 002 - Data Types
        ...
        Overview
        - Recognize int, float, str, and bool values and convert between them safely.
        ...
        Learning outcomes
        - Explain the main idea of data types in simple language.
...
- review one common beginner bug and how to fix it
        ...
        Practice samples
        1. a type-inspection worksheet for basic Python values
