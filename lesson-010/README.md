# Lesson 010 - Mini Project: Student Management System
        ...
        Overview
        - Combine variables, conditions, loops, functions, and collections into one interactive program.
        - Build syntax confidence, control flow, functions, and collection skills from zero.
        - The session focuses on one clear topic, three guided practice tasks, and a short homework extension.

        Learning outcomes
        - Explain the main idea of mini project: student management system in simple language.
...
- review one common beginner bug and how to fix it
        ...
        Practice samples
        1. a student management mini project with search and score updates
        ...
        Homework
        - Rebuild the main exercise from memory, change the input values, and explain the logic in plain English.
        - Save one mistake, one fix, and one takeaway in your own study notes.

        Self-practice
        - Spend 45 minutes repeating the main task and 45 minutes extending it with new inputs or a small rule change.
