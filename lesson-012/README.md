# Lesson 012 - Advanced Functions
        ...
        Overview
        - Use lambda, map, filter, and higher-order thinking to simplify repeated work.
        - Learn to organize code, handle errors, work with files, and think in reusable pieces.
        - The session focuses on one clear topic, three guided practice tasks, and a short homework extension.

        Learning outcomes
        - Explain the main idea of advanced functions in simple language.
...
- explain the trade-off between the quick solution and the reusable solution
        ...
        Practice samples
        1. a functional-style data cleaner using lambda, map, and filter
        ...
        Homework
        - Rewrite the lesson exercise with your own data, then add one robustness improvement.
        - Save one mistake, one fix, and one takeaway in your own study notes.

        Self-practice
        - Spend 1 hour rebuilding the exercise and 1 hour improving the design, error handling, or reuse.
