# Lesson 045 - TensorFlow / PyTorch
        ...
        Overview
        - Build, train, evaluate, and predict with a first deep learning model.
        ...
        Learning outcomes
        - Explain the main idea of tensorflow / pytorch in simple language.
...
- compare a healthy training run with a broken one
        ...
        Practice samples
        1. a first framework-based model for tabular or toy data
