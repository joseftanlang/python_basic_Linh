# Lesson 037 - Linear Regression
        ...
        Overview
        - Connect cost functions, gradient descent, and prediction lines.
        ...
        Learning outcomes
        - Explain the main idea of linear regression in simple language.
...
- compare baseline, improvement, and failure cases
        ...
        Practice samples
        1. a linear regression notebook with slope and error intuition
