# Lesson 031 - Probability Distributions
        ...
        Overview
        - Recognize normal, binomial, and Poisson distributions and when to use them.
        - Build statistical reasoning so model results and data patterns can be interpreted correctly.
        - The session focuses on one clear topic, three guided practice tasks, and a short homework extension.

        Learning outcomes
        - Explain the main idea of probability distributions in simple language.
...
- link each statistic to a decision or claim about the data
        ...
        Practice samples
        1. a distribution simulator for common probability models
        ...
        Homework
        - Compute the same statistic on a different dataset and explain what changes.
        - Save one mistake, one fix, and one takeaway in your own study notes.

        Self-practice
        - Spend 1 hour solving by hand and 1 hour checking your work with code or a calculator.
