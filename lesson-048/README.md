# Lesson 048 - Prompt Engineering
        ...
        Overview
        - Use zero-shot, one-shot, few-shot, chain-of-thought, and evaluation habits.
        ...
        Learning outcomes
        - Explain the main idea of prompt engineering in simple language.
...
- name the main failure mode and the way to measure it
        ...
        Practice samples
        1. a prompt engineering workbook with quality checks
