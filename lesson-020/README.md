# Lesson 020 - Project: Inventory Management System
        ...
        Overview
        - Build a larger program that combines collections, functions, files, and search.
        ...
        Learning outcomes
        - Explain the main idea of project: inventory management system in simple language.
...
- explain the trade-off between the quick solution and the reusable solution
        ...
        Practice samples
        1. an inventory management project with file-backed storage
