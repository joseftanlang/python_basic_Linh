# Lesson 050 - LLM Fine-Tuning & Capstone
        ...
        Overview
        - Connect fine-tuning, evaluation, deployment, and an end-to-end AI project.
        ...
        Learning outcomes
        - Explain the main idea of llm fine-tuning & capstone in simple language.
...
- name the main failure mode and the way to measure it
        ...
        Practice samples
        1. a capstone roadmap from raw data to deployed AI application
