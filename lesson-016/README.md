# Lesson 016 - OOP Part 2
        ...
        Overview
        - Use inheritance, polymorphism, and encapsulation to design reusable code.
        ...
        Learning outcomes
        - Explain the main idea of oop part 2 in simple language.
...
- explain the trade-off between the quick solution and the reusable solution
        ...
        Practice samples
        1. a school hierarchy that reuses a base class
